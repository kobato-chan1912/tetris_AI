package com.harunaga.games.common.client.sound;

import java.io.*;
import javax.sound.sampled.*;
import com.harunaga.games.common.client.util.ThreadPool;
import com.harunaga.games.common.client.util.LoopingByteInputStream;
...
public class SoundManager extends ThreadPool {
    ...
    public static int getMaxSimultaneousSounds(
        ...
        //fix bug return -1 on harunaga's computer
        int a = mixer.getMaxLines(lineInfo);
        return a > 1 ? a : 1;
    }
