package com.harunaga.games.common.client.gamecore;
...
public abstract class GameCore implements Runnable {
    ...
    public GameCore(ScreenManager screen) {
        this.screen = screen;
    }
    ...
    public void init() {
        isRunning = true;
        screen.init();
        Insets inset = screen.getScreen().getInsets();
        offsetX = inset.left;
        offsetY = inset.top;
    }
    ...
    public void gameLoop() {
        ...
        while (isRunning) {
            ...
            // take a nap! if not run at linux may get problem
            try {
                Thread.sleep(50);
            } catch (InterruptedException ex) {
            }
