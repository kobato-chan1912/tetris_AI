...
public class Attachment {
    ...
    /** The player for the channel this attachment is being attached*/
    ...
    public byte payload[];
    public int oldGameNameHash;

    public int getOldGameNameHash() {
        return oldGameNameHash;
    }
    ...
    public Attachment() {
        ...
        oldGameNameHash = gameNameHash = 0;//consider gameName="" for not detemine the game yet
        player = null;//not determine player of what game yet
    }
